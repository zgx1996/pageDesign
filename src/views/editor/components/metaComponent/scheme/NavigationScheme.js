...
const ElDropdown = {
  propsConfig: {
    ...
    size: {
      label: '菜单尺寸',
      type: PROPS_TYPES.enum,
      enumData: [{label: 'medium', value: 'medium'},{label: 'small', value: 'small'},{label: 'mini', value: 'mini'}]
    },
    splitButton:{
      label: '下拉触发元素呈现为按钮组',
      type: PROPS_TYPES.boolean
    ...
    placement:{
      label: '菜单弹出位置',
      type: PROPS_TYPES.enum,
      enumData: [{label: 'top', value: 'top'},{label: 'top-start', value: 'top-start'},{label: 'top-end', value: 'top-end'},
                  {label: 'bottom', value: 'bottom'},{label: 'bottom-start', value: 'bottom-start'},{label: 'bottom-end', value: 'bottom-end'}
                ]
    },
    trigger:{
      label: '触发下拉的行为',
      type: PROPS_TYPES.enum,
      enumData:[{label:'hover', value:'hover'}, {label:'click', value:'click'}]
    },
    hideOnClick:{
      label: '是否在点击菜单项后隐藏菜单',
      type: PROPS_TYPES.boolean
    ...
    showTimeout:{
      label: '展开下拉菜单的延时（仅在 trigger 为 hover 时有效）',
      type: PROPS_TYPES.number
    },
    hideTimeout:{
      label: '收起下拉菜单的延时（仅在 trigger 为 hover 时有效）',
      type: PROPS_TYPES.number
    },
    tabindex:{
      label: 'Dropdown 组件的 tabindex',
      type: PROPS_TYPES.number
    },
    disabled:{
      label: '是否禁用',
...
export default { ElTabs, ElTabPane, ElMenu, ElSubmenu, ElMenuItem, ElMenuItemGroup, ElDropdown, ElDropdownMenu, ElDropdownItem }